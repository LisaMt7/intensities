...
`}render(){return v`
    ...
    `}static get properties(){return{placeholder:{type:String},items:{type:Object},value:{type:String,reflect:!0}}}render(){let e=new RegExp(this.value,"i");return v`
      ...
      `}}customElements.define("visualscript-search",Ct);class De extends E{constructor(e={}){super(),this.persist=!1,this.optionChecked="",this.optionHoveredIndex=-1,this.options=[],this.onChange=()=>{},this.add=i=>{this.options=[...this.options,i],this.render()},this.openSelectCustom=()=>{if(this.elements.elSelectCustom.classList.add("isActive"),this.elements.elSelectCustom.setAttribute("aria-hidden","false"),this.optionChecked){let i=this.elements.customOptsList.findIndex(s=>s.getAttribute("data-value")===this.optionChecked);this.updateCustomSelectHovered(i)}document.addEventListener("keydown",this.supportKeyboardNavigation)},this.closeSelectCustom=()=>{this.elements.elSelectCustom.classList.remove("isActive"),this.elements.elSelectCustom.setAttribute("aria-hidden","true"),this.updateCustomSelectHovered(-1),document.removeEventListener("keydown",this.supportKeyboardNavigation)},this.updateCustomSelectHovered=i=>{let s=this.elements.elSelectCustomOpts.children[this.optionHoveredIndex],n=this.elements.elSelectCustomOpts.children[i];s&&s.classList.remove("isHover"),n&&n.classList.add("isHover"),this.optionHoveredIndex=i},this.updateCustomSelectChecked=(i,s)=>{if(this.elements){s||(s=this.elements.elSelectCustomOpts.querySelectorAll(`[data-value="${i}"]`)[0]?.textContent);let n=this.optionChecked,a=this.elements.elSelectCustomOpts.querySelector(`[data-value="${n}"`),o=this.elements.elSelectCustomOpts.querySelector(`[data-value="${i}"`);a&&a.classList.remove("isActive"),o&&o.classList.add("isActive");let d=this.elements.elSelectCustom.children[0].children[0];d.textContent=s,this.optionChecked=i}},this.watchClickOutside=i=>{!this.contains(i.target)&&this.closeSelectCustom()},this.supportKeyboardNavigation=i=>{if(i.keyCode===40&&this.optionHoveredIndex<this.optionsCount-1&&(this.optionHoveredIndex,i.preventDefault(),this.updateCustomSelectHovered(this.optionHoveredIndex+1)),i.keyCode===38&&this.optionHoveredIndex>0&&(i.preventDefault(),this.updateCustomSelectHovered(this.optionHoveredIndex-1)),i.keyCode===13||i.keyCode===32){i.preventDefault();let s=this.elements.elSelectCustomOpts.children[this.optionHoveredIndex],n=s&&s.getAttribute("data-value");n&&(this.elements.elSelectNative.value=n,this.updateCustomSelectChecked(n,s.textContent)),this.closeSelectCustom()}i.keyCode===27&&this.closeSelectCustom()},this.options=e.options??[],e.onChange&&(this.onChange=e.onChange),e.label&&(this.label=e.label),e.persist&&(this.persist=e.persist);let t=Se(e);t&&(this.value=t)}static get styles(){return $`
    ...
    */
    ...
    `}}customElements.define("visualscript-file",Be);class Ne extends E{constructor(e={}){super(),this.persist=!1,this.onChange=()=>{},e.onChange&&(this.onChange=e.onChange),e.label&&(this.label=e.label),e.persist&&(this.persist=e.persist);let t=Se(e);t&&(this.value=t)}static get styles(){return $`
    ...
    `}}customElements.define("visualscript-switch",Ne);class He extends E{constructor(e={}){super(),this.persist=!1,this.onChange=()=>{},this.onInput=()=>{},e.onChange&&(this.onChange=e.onChange),e.label&&(this.label=e.label),e.persist&&(this.persist=e.persist);let t=Se(e);t&&(this.value=t)}static get styles(){return $`
